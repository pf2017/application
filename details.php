...
while($d=mysql_fetch_array($sql)){?>
		...
		<h3>Payement Total= <?php echo $d['prix'];?> TND </h3> 
			...
			<div class="col-md-4">
			<a href="pay.php?id=<?php echo $d['id'];?>" class="btn  btn-info">Je paye en ligne</a>
			...
			<div class="col-md-6">
				            <div class="tm-about-box-2-text">
								<h3 class="tm-about-box-2-title"><?php echo $d['address'];?></h3>
                                <p>Adresse=<?php echo $d['address']?><br>Telephone=<?php echo $d['telephone']?></p>
								 <br><br><br><br><br><br><br><br><br><br><br> 
                                <p class="tm-about-box-2-footer" color="green">Disponible</p>								   
							</div>	
